...
The following business questions were answered using SQL queries:
  ...
  3. Top 5 Products by Review Rating – Ranked products based on average customer ratings

  4. Shipping Type Comparison – Compared average purchase value for Standard vs Express shipping

  5. Subscribers vs Non-Subscribers – Analyzed average spend and total revenue
  ...
  8. Top Products per Category – Ranked top 3 products within each category

  9. Repeat Buyers & Subscriptions – Evaluated subscription likelihood among repeat customers
